    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <div className="mb-2 flex flex-col gap-5.5 sm:flex-row">
          ...
          <div className="w-full sm:w-1/3">
            <h1 className=" text-lm font-bold text-bodydark2"> AppENSPD</h1>
          </div>
        </div>
      </div>
      {/* <!-- SIDEBAR HEADER --> */}
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          {/* <!-- Menu Group --> */}
          <div>
            <h3 className="mb-4 ml-4 text-sm font-bold text-bodydark2">
              MENU
            </h3>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <!-- Menu Item Profile --> */}
              {/* <!-- Menu Item ListingUsers --> */}
              <li>
                <NavLink
                  to="/ListingUsers"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('ListingUsers') &&
                    'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg
              ...
              {/* <!-- Menu Item Listing Ressources --> */}
              <li>
                <NavLink
                  to="/ListingRessources"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('ListingRessources') &&
                    'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg
                    ...
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <NavLink
                              to="/AddElements/ReserverRessource"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
